...
export default function Stan() {
  ...
  return (
    <LayoutDetail
      title={`Projekt Križevci - Stan ${apartment?.naziv}`}
      desc="Projekt Križevci"
      ...
      <section className={styles.apartmentDetails}>
        ...
        <ImageGallery
          slides={[
            ...
            <Image
              key={img}
              src={`/projekt-krizevci/tlocrti/${img}.png`}
              alt="Projekt Križevci - stanovi"
              width={720}
              height={480}
            />
        ...
        {/* <div className={styles.kontakt}>
          ...
          <div className={styles.formWrap}>
            <Form apartment={apartment?.naziv} zgrada="Projekt Križevci" />
          </div>
        </div> */}
      </section>
    </LayoutDetail>
