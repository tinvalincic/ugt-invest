...
export default function Stan() {
  ...
  const apartment = getApartment(frankopanska3Apartments, stan);
  ...
  return (
    <LayoutDetail
      title={`Projekt Frankopanska 3 - Stan ${apartment?.naziv}`}
      desc="Projekt Frankopanska 3"
      ...
      <section className={styles.apartmentDetails}>
        ...
        <div className={styles.kontakt}>
          ...
          <div className={styles.formWrap}>
            <Form apartment={apartment.naziv} zgrada="Projekt Frankopanska 3" />
          </div>
        </div>
      </section>
    </LayoutDetail>
