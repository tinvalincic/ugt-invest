...
export const Frankopanska3ImageGallery = () => (
  <ImageGallery
    slides={new Array(6).fill("").map((_, i) => (
      <Image
        key={i}
        src={`/projekt-frankopanska3/${i + 1}.jpg`}
        alt="Projekt Frankopanska 3 - stanovi"
        width={1920}
        height={1080}
      />
    ))}
...
export const SvAntunImageGallery = () => (
  <ImageGallery
    slides={new Array(8).fill("").map((_, i) => (
      <Image
        key={i}
        src={`/projekt-sv-antun/${i + 1}.jpeg`}
        alt="Projekt Sv. Antun - stanovi"
        width={1024}
        height={768}
      />
    ))}
